...
export class EventsService {
  ...
  async update(id: string, updateEventDto: UpdateEventDto) {
    ...
    // Asegurarse de que ExpressionAttributeValues esté definido y filtrar valores undefined
    if (params.ExpressionAttributeValues) {
      ...
      params.ExpressionAttributeValues = {}; // Valor por defecto si está undefined
    }
